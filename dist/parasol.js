(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('d3'), require('@jrkasprzyk/parcoord-es'), require('slickgrid-es6'), require('lodash-es'), require('ml-kmeans'), require('d3-dsv')) :
  typeof define === 'function' && define.amd ? define(['d3', '@jrkasprzyk/parcoord-es', 'slickgrid-es6', 'lodash-es', 'ml-kmeans', 'd3-dsv'], factory) :
  ...
  var init = function init(config) {
    ...
    var _ps = function ps(selection) {
      selection = _ps.selection = d3.selectAll(selection);
  ...
  var sync = function sync(config, ps, flags) {
    return function () {
      ...
      if (lodashEs.union.apply(void 0, brush_extents).length == 0) {
        ps.linked.forEach(function (pc) {
          pc.brushReset();
        });
        config.brushed = [];
        ...
        var brushed = lodashEs.intersection.apply(void 0, brush_extents);
        ps.linked.forEach(function (pc) {
  ...
  var cluster = function cluster(config, ps, flags) {
    return function () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        palette = _ref$palette === void 0 ? d3.schemeCategory10 : _ref$palette,
        _ref$options = _ref.options,
  ...
  var exportData = function exportData(config, ps, flags) {
    return function (_ref) {
      ...
      if (d.length > 0) {
        ...
        var csv = d3Dsv.csvFormat(d, config.vars);
