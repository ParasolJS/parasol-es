...
(function (global, factory) {
    ...
    */
      ...
      */
    	var ps = function ps(selection$$1) {
    		...
    		selection$$1.each(function (d, i) {
    			ps.charts[i] = ParCoords(config.chartOptions)(this).data(config.data).alpha(0.4).render();
    		});
    		// for chained api
    		return ps;
    	};
    ...
    var root$3 = /*#__PURE__*/Object.freeze({
    ...
    function isSymbol(value) {
        return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'symbol' || isObjectLike(value) && baseGetTag$1(value) == symbolTag;
    }
    ...
    function spread(func, start) {
      ...
      start = start == null ? 0 : nativeMax$1(toInteger_1(start), 0);
    ...
    /* Built-in method references that are verified to be native. */
    var Map$2 = _getNative(root$3, 'Map');
    ...
    /* Built-in method references that are verified to be native. */
    var Set$1 = _getNative(root$3, 'Set');
    ...
    function isArrayLikeObject(value) {
      return isObjectLike$2(value) && isArrayLike_1(value);
    }
    ...
    var sync = function sync(config, ps) {
    	return function () {
    		...
    		if (spread_1(union_1)(brush_extents).length == 0) {
    			config.linked.forEach(function (pc) {
    				pc.brushReset();
    			});
    			...
    			var brushed = spread_1(intersection_1)(brush_extents);
    			config.linked.forEach(function (pc) {
