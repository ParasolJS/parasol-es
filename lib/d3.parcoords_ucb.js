...
var events = d3.dispatch.apply(this,["render", "resize", "highlight", "mark", "brush", "brushend", "brushstart", "axesreorder"].concat(d3.keys(__))),
...
(function() {
  ...
  function selected() {
    ...
    var test = __.data
      ...
      console.log("test: ", Object.keys(test).length, test);
      return test;
  };
